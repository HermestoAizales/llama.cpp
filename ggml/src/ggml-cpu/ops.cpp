...
// HISA Data Helpers
static inline const float * get_data_f32_const(const ggml_tensor * t) { return (const float *)t->data; }
static inline float * get_data_f32(ggml_tensor * t) { return (float *)t->data; }
static inline const uint16_t * get_data_hf16_const(const ggml_tensor * t) { return (const uint16_t *)t->data; }
static inline uint16_t * get_data_hf16(ggml_tensor * t) { return (uint16_t *)t->data; }


// ============================================================ //
// HISA CPU Implementations
// ============================================================ //
